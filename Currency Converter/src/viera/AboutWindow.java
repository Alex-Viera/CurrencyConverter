...
public class AboutWindow extends JFrame {
    ...
    private AboutWindow() {
        ...
        JLabel lblLink = new JLabel("https://github.com/Alex-Viera");
        ...
        lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://github.com/Alex-Viera"));
                } catch (Exception ex) {
                    ex.printStackTrace();
                }
            }
        ...
        // label "title"
        JLabel lblTitle = new JLabel("Currency Converter {K♣}");
